...
ListModel {
    ...
    function addShape(shape) {
        ...
        var extent = shape.boundingGeoRectangle();
        var coordinate = extent.center;
        ...
        if (cell.count) {
            cell.xMin = Math.min(cell.xMin, topLeft.longitude, bottomRight.longitude);
            cell.xMax = Math.max(cell.xMax, topLeft.longitude, bottomRight.longitude);
            cell.yMin = Math.min(cell.yMin, topLeft.latitude, bottomRight.latitude);
            cell.yMax = Math.max(cell.yMax, topLeft.latitude, bottomRight.latitude);
        } else {
            cell.xMin = topLeft.longitude;
            cell.yMin = bottomRight.latitude;
            cell.xMax = bottomRight.longitude;
            cell.yMax = topLeft.latitude;
        }
