...
ContextMenu {
    ...
    ContextMenuItem {
        ...
        icon.source: "images/undo-24.svg"
    ...
    ContextMenuItem {
        ...
        visible: !inputControl.readOnly
        icon.source: "images/redo-24.svg"
    ...
    ContextMenuItem {
        ...
        visible: !inputControl.readOnly
        icon.source: "images/scissors-24.svg"
    ...
    ContextMenuItem {
        ...
        enabled: inputControl.selectedText.length > 0
        visible: !inputControl.readOnly
        icon.source: "images/copy-to-clipboard-24.svg"
    ...
    ContextMenuItem {
        ...
        icon.source: "images/paste-24.svg"
    ...
    ContextMenuItem {
        ...
        icon.source: "images/blank-24.svg"
