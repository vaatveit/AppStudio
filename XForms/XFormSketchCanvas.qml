...
Rectangle {
    ...
    function fitImageObject(imageObject) {
        ...
        if (imageRatio < canvasRatio) {
            height = canvas.height * Screen.devicePixelRatio;
            width = height * imageRatio;
        } else {
            width = canvas.width * Screen.devicePixelRatio;
            height = width / imageRatio;
        }

        var x = (canvas.width * Screen.devicePixelRatio - width) / 2;
        var y = (canvas.height * Screen.devicePixelRatio - height) / 2;
    ...
    function resizeImageObject(imageObject) {
        ...
        if (imageRatio < canvasRatio) {
            imageObject.scaleToHeight(canvas.height * Screen.devicePixelRatio, ImageObject.TransformationModeSmooth);
        } else {
            imageObject.scaleToWidth(canvas.width * Screen.devicePixelRatio, ImageObject.TransformationModeSmooth);
        }
    ...
    function setOffsets(imageObject){
        ...
        imageObject.offsetX = (canvas.width * Screen.devicePixelRatio - imageObject.width) / 2;
        imageObject.offsetY = (canvas.height * Screen.devicePixelRatio - imageObject.height) / 2;
    }
